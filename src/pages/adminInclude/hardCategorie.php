<?php 
    ...
    ?>
            <tr>
                <td><?=$value?></td>
                <td class="ta-c tc-r"><a href="../../src/pages/admin?delete=true&value=<?=$value?>"><i class="far fa-trash-alt"></i></a></td>
            </tr>
    <?php endforeach?> 
            <tr>
                <td>Ajouter une console</td>
                <td class="ta-c tc-g"><a href="../../src/pages/admin?create=true"><i class="far fa-plus-square"></i></a></td>
            </tr>
    <?php
        // Je conditionne l'accès à ces requête uniquement si l'utilsateur est admin
        if(isset($_SESSION["user"]["role"]) && $_SESSION["user"]["role"] == "admin"){
